...
```
```{r}
plot.multi_doe_branched(res_multi, branch_mode= "facet")
```
```{r}
res <- res_multi

# 1) Overall aggregate DOE across trajectories
plot.multi_doe_branched(res, scope = "overall", type = "bar")

# 2) Per-branch bar plot, faceted by branch
plot.multi_doe_branched(res, scope = "branch",
